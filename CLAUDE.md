# Claude Memory for Xcode Template Project

This file contains important context and memories for Claude when working on this Xcode template project. This helps maintain consistency and understanding across sessions.

## Project Overview

This is a comprehensive Xcode project template that provides a complete foundation for modern iOS, macOS, watchOS, tvOS, and visionOS app development using Swift 6.2 and SwiftUI.
...
```
Sources/
├── Core/                    # Business logic, models, App Intents
│   ├── CoreModule.swift     # Main module with GreetingIntent
│   ├── LocalizationExtensions.swift  # Clean SwiftUI localization API
│   └── Resources/
│       └── Localizable.xcstrings    # Shared localization file
└── UI/                      # SwiftUI components and design system
    └── UIComponents.swift   # Platform-specific UI components
```
...
│   ├── ContentView.swift
│   └── AppShortcutsProvider.swift   # MyAppShortcutsProvider
